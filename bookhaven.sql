...
--
-- Host: 127.0.0.1    Database: bookhaven
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  KEY `books_ibfk_2_idx` (`author_id`),
  KEY `books_ibfk_3_idx` (`genre_id`),
  CONSTRAINT `books_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`supplier_id`),
...
-- Dump completed on 2025-04-20 12:08:20
